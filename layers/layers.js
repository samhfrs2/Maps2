...
var format_Joinedlayer_2 = new ol.format.GeoJSON();
var features_Joinedlayer_2 = format_Joinedlayer_2.readFeatures(json_Joinedlayer_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Joinedlayer_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Joinedlayer_2.addFeatures(features_Joinedlayer_2);
var lyr_Joinedlayer_2 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Joinedlayer_2, 
                style: style_Joinedlayer_2,
                popuplayertitle: 'Joined layer',
                interactive: false,
                title: '<img src="styles/legend/Joinedlayer_2.png" /> Joined layer'
            });
var format_datay5TQa_3 = new ol.format.GeoJSON();
var features_datay5TQa_3 = format_datay5TQa_3.readFeatures(json_datay5TQa_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_datay5TQa_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_datay5TQa_3.addFeatures(features_datay5TQa_3);
var lyr_datay5TQa_3 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_datay5TQa_3, 
                style: style_datay5TQa_3,
                popuplayertitle: 'data-y5TQa',
                interactive: true,
                title: '<img src="styles/legend/datay5TQa_3.png" /> data-y5TQa'
            });

lyr_LightGray_0.setVisible(true);lyr_Einwohner_1.setVisible(true);lyr_Joinedlayer_2.setVisible(true);lyr_datay5TQa_3.setVisible(true);
var layersList = [lyr_LightGray_0,lyr_Einwohner_1,lyr_Joinedlayer_2,lyr_datay5TQa_3];
...
lyr_Joinedlayer_2.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'STATIST_BE': 'STATIST_BE', 'NR_STATIST': 'NR_STATIST', 'NAME_STATI': 'NAME_STATI', 'STADTBEZIR': 'STADTBEZIR', 'SHAPE_AREA': 'SHAPE_AREA', 'SHAPE_LEN': 'SHAPE_LEN', 'Einwohner': 'Einwohner', 'X.1_count': 'X.1_count', 'X.1_sum': 'X.1_sum', 'EinwohnerP': 'EinwohnerP', });
lyr_datay5TQa_3.set('fieldAliases', {'X.1': 'X.1', 'Praxis': 'Praxis', 'LAT': 'LAT', 'LON': 'LON', 'Adresse': 'Adresse', 'DocName': 'DocName', });
...
lyr_Joinedlayer_2.set('fieldImages', {'OBJECTID': 'TextEdit', 'STATIST_BE': 'TextEdit', 'NR_STATIST': 'TextEdit', 'NAME_STATI': 'TextEdit', 'STADTBEZIR': 'TextEdit', 'SHAPE_AREA': 'TextEdit', 'SHAPE_LEN': 'TextEdit', 'Einwohner': 'TextEdit', 'X.1_count': 'TextEdit', 'X.1_sum': 'TextEdit', 'EinwohnerP': 'TextEdit', });
lyr_datay5TQa_3.set('fieldImages', {'X.1': 'Range', 'Praxis': 'TextEdit', 'LAT': 'TextEdit', 'LON': 'TextEdit', 'Adresse': 'TextEdit', 'DocName': 'TextEdit', });
...
lyr_Joinedlayer_2.set('fieldLabels', {'OBJECTID': 'no label', 'STATIST_BE': 'no label', 'NR_STATIST': 'no label', 'NAME_STATI': 'no label', 'STADTBEZIR': 'no label', 'SHAPE_AREA': 'no label', 'SHAPE_LEN': 'no label', 'Einwohner': 'no label', 'X.1_count': 'no label', 'X.1_sum': 'no label', 'EinwohnerP': 'no label', });
lyr_datay5TQa_3.set('fieldLabels', {'X.1': 'hidden field', 'Praxis': 'inline label - visible with data', 'LAT': 'hidden field', 'LON': 'hidden field', 'Adresse': 'inline label - visible with data', 'DocName': 'inline label - visible with data', });
lyr_datay5TQa_3.on('precompose', function(evt) {
